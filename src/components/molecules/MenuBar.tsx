...
export const MenuBar = ({ editor }: { editor: any }) => {
  ...
  return (
    <div className="flex flex-row flex-wrap items-center gap-1  px-5 py-2 rounded-t-md ring-2 ">
      <a
        className={editor.isActive('bold') ? 'bg-gray-200 rounded-md' : 'hover:bg-gray-200 duration-200 rounded-md'}
        href="#"
      ...
      <a
        className={editor.isActive('italic') ? 'bg-gray-200 rounded-md' : 'hover:bg-gray-200 duration-200 rounded-md'}
        href="#"
      ...
      <a
        className={editor.isActive('strike') ? 'bg-gray-200 rounded-md' : 'hover:bg-gray-200 duration-200 rounded-md'}
        href="#"
      ...
      <a
        className={editor.isActive('code') ? 'bg-gray-200 rounded-md' : 'hover:bg-gray-200 duration-200 rounded-md'}
        href="#"
      ...
      <a
        className={
          editor.isActive('highlight') ? 'bg-gray-200 rounded-md' : 'hover:bg-gray-200 duration-200 rounded-md'
        }
        href="#"
      ...
      <a
        className={
          editor.isActive('bulletList') ? 'bg-gray-200 rounded-md' : 'hover:bg-gray-200 duration-200 rounded-md'
        }
        href="#"
      ...
      <a
        className={
          editor.isActive('orderedList') ? 'bg-gray-200 rounded-md' : 'hover:bg-gray-200 duration-200 rounded-md'
        }
        href="#"

...
export function ArticleContents({setTitle, title, setContent, content, setTags, tags}: ArticleContentsProps) {
  return (
    <div className=" mx-auto flex flex-col">
      <InputField onChange={setTitle} placeholder="Title" type="text" value={title} width="1000px"/>
      <InputField onChange={setTags} placeholder="Tags" type="text" value={tags} width="1000px"/>

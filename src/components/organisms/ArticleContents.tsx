...
export function ArticleContents({ setTitle, title, setContent, setTags, tags, finished }: ArticleContentsProps) {
  return (
      ...
      <div className="w-full flex-col">
        <div className="flex-col flex justify-center">
          ...
          <div className="m-3">
            ...
            <InputField onChange={setTags} placeholder="Tag" type="text" value={tags} />
          </div>
        </div>
